...
void ProposeLiteral(Relation R, Boolean TF, Var *A, int Size, float LitBits,
		int OPos, int OTot, float Gain, Boolean Weak)
		/*    --------------  */
		{
...
/*       -------  */
{
	...
	if (SavedClause || !NToBeTried || MAXRECOVERS-- < 1)
		return Nil;
